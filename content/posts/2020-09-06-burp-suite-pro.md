...
2. Burp Suite Pro zip file (2021.4.1) - [Download](https://t.me/burpsuite/247)
...
Now extract the downlaoded `BurpSuite_Pro_2021.4.1.zip` file. Use the password: 311138 if prompted. You will see three `.jar` files and one `.txt` file inside. In the same folder:
...
- Paste and run the following command:
  ...
  `java -javaagent:BurpSuiteLoader_v2021.4.1.jar -noverify -jar burpsuite_pro_v2021.4.1.jar`
