...
2. Burp Suite Pro zip file (2021.3.2) - [Download](https://t.me/burpsuite/230)
...
Now extract the downlaoded `BurpSuite_Pro_2021.3.2.zip` file. Use the password: 311138 if prompted. You will see three `.jar` files and one `.txt` file inside. In the same folder:
